...
> Минимальная версия для текущего кода – Java 16 (из-за `switch` со стрелками `case X ->` и использованием оператора `instanceof`)
...
По умолчанию предлагается использовать систему сборки Maven, ниже приведены типовые команды:
